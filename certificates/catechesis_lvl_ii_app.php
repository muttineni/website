...
$page_info['page'] = 'cat-lvl-ii-app';
$page_info['login_required'] = 1;
list($user_info, $lang, $status_message, $header) = vlc_header($site_info, $page_info);
/* get catechesis certificate application status from session variable */
if (!isset($_SESSION['cat_cert_app_status']) or $_SESSION['cat_cert_app_status'] != 3) vlc_redirect('certificates/catechesis.php');
...
{
  if ($user_details['is_partner']) $user_details['diocese'] .= ' ('.$lang['certificates']['cat-lvl-ii-app']['content']['partner'].')';
  else $user_details['diocese'] .= ' ('.$lang['certificates']['cat-lvl-ii-app']['content']['non-partner'].')';
}
else
{
  $user_details['diocese'] = $lang['certificates']['cat-lvl-ii-app']['content']['no-diocese'];
}
$hidden_fields_string = '<input type="hidden" name="cert_prog_id" value="2">';
$hidden_fields_string .= '<input type="hidden" name="app_lang" value="1">';
$hidden_fields_string .= '<input type="hidden" name="certificate_program" value="'.$lang['certificates']['cat-lvl-ii-app']['content']['cert-prog'].'">';
...
<!-- begin page content -->
<div class="container">
<h1><?php print $lang['certificates']['cat-lvl-ii-app']['page-title'] ?></h1>
<div class="card"><form action="cert_app_action.php" method="post" onsubmit="return validate_form(this)">
  <div class="card-body">
    <div class="alert alert-info">
      <ul>
        <li><?php print $lang['certificates']['cat-lvl-ii-app']['content']['app-fee'] ?></li>
        <li><?php print $lang['certificates']['cat-lvl-ii-app']['content']['all-fields-required'] ?></li>
      </ul>
    </div>
    <?php echo $hidden_fields_string ?>
    <div class="form-group row">
      <label for="display_date" class="col-sm-3 col-form-label">
        <?php echo $lang['certificates']['cat-lvl-ii-app']['content']['date'] ?>
      </label>
      <div class="col-sm-9">
    ...
    <div class="form-group row">
      <label for="display_name" class="col-sm-3 col-form-label">
        <?php echo $lang['certificates']['cat-lvl-ii-app']['content']['name'] ?>
      </label>
      <div class="col-sm-9">
    ...
    <div class="form-group row">
      <label for="display_username" class="col-sm-3 col-form-label">
        <?php echo $lang['certificates']['cat-lvl-ii-app']['content']['username'] ?>
      </label>
      <div class="col-sm-9">
    ...
    <div class="form-group row">
      <label for="display_email" class="col-sm-3 col-form-label">
        <?php echo $lang['certificates']['cat-lvl-ii-app']['content']['email-address'] ?>
      </label>
      <div class="col-sm-9">
    ...
    <div class="form-group row">
      <label for="display_diocese" class="col-sm-3 col-form-label">
        <?php echo $lang['certificates']['cat-lvl-ii-app']['content']['diocese'] ?>
      </label>
      <div class="col-sm-9">
    ...
    <div class="form-group row">
      <label for="parish_school_name" class="col-sm-3 col-form-label">
        <?php echo $lang['certificates']['cat-lvl-ii-app']['content']['parish-school-name'] ?>
      </label>
      <div class="col-sm-9">
  ...
  <div class="card-body">
    <div class="alert alert-info">
      <?php echo $lang['certificates']['cat-lvl-ii-app']['content']['current-ministry'] ?>
    </div>
    <div class="form-group row">
      <label for="parish_program" class="col-sm-3 col-form-label">
        <?php echo $lang['certificates']['cat-lvl-ii-app']['content']['parish-program'] ?>
      </label>
      <div class="col-sm-9">
    ...
    <div class="form-group row">
      <label for="parish_program_grade_level" class="col-sm-3 col-form-label">
        <i class="fa fa-arrow-right"></i> <?php echo $lang['certificates']['cat-lvl-ii-app']['content']['grade-level'] ?>
      </label>
      <div class="col-sm-9">
    ...
    <div class="form-group row">
      <label for="catholic_school" class="col-sm-3 col-form-label">
        <?php echo $lang['certificates']['cat-lvl-ii-app']['content']['catholic-school'] ?>
      </label>
      <div class="col-sm-9">
  ...
  <div class="card-body">
    <div class="form-group">
      <label for="reason_to_participate">
        <?php echo $lang['certificates']['cat-lvl-ii-app']['content']['reason-to-participate'] ?>
      </label>
    ...
    <div class="form-group">
      <label for="workshops_or_courses">
        <?php echo $lang['certificates']['cat-lvl-ii-app']['content']['workshops-courses'] ?>
      </label>
    ...
    <div class="form-group">
      <label for="other_ministry">
        <?php echo $lang['certificates']['cat-lvl-ii-app']['content']['other-ministry'] ?>
      </label>
    ...
    <input type="submit" class="submit-button btn btn-vlc" value="<?php print $lang['certificates']['cat-lvl-ii-app']['content']['submit'] ?>">
  </div>
