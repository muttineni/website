...
END_QUERY;
  ...
  {
    $register_link .= '<li><b>'.vlc_internal_link($lang['certificates']['catechesis-sp']['content']['register-level-i'], 'certificates/es_catechesis_lvl_i_app.php').'</b></li>';
  ...
  {
    $register_link .= '<li><b>'.$lang['certificates']['catechesis-sp']['content']['register-level-i'].'</b><ul><li>'.$lang['certificates']['catechesis-sp']['content']['already-registered'].'</li></ul></li>';
    $register_link .= '<li><b>'.vlc_internal_link($lang['certificates']['catechesis-sp']['content']['register-level-ii'], 'certificates/es_catechesis_lvl_ii_app.php').'</b></li>';
