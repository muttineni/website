...
$page_info['page'] = 'es-ministerio-lev-1-app';
$page_info['login_required'] = 1;
list($user_info, $lang, $status_message, $header) = vlc_header($site_info, $page_info);
/* get catechesis certificate application status from session variable */
if (!isset($_SESSION['es_ministerio_cert_app_status']) or $_SESSION['es_ministerio_cert_app_status'] != 1) vlc_redirect('certificates/es_ministerio.php');
...
{
  if ($user_details['is_partner']) $user_details['diocese'] .= ' ('.$lang['certificates']['es-ministerio-lev-1-app']['content']['partner'].')';
  else $user_details['diocese'] .= ' ('.$lang['certificates']['es-ministerio-lev-1-app']['content']['non-partner'].')';
}
else
{
  $user_details['diocese'] = $lang['certificates']['es-ministerio-lev-1-app']['content']['no-diocese'];
}
$hidden_fields_string = '<input type="hidden" name="cert_prog_id" value="16">';
$hidden_fields_string .= '<input type="hidden" name="app_lang" value="2">';
$hidden_fields_string .= '<input type="hidden" name="certificate_program" value="'.$lang['certificates']['es-ministerio-lev-1-app']['content']['cert-prog'].'">';
...
<!-- begin page content -->
<div class="container">
<h1><?php print $lang['certificates']['es-ministerio-lev-1-app']['page-title'] ?></h1>
<div class="card"><form action="cert_app_action.php" method="post" onsubmit="return validate_form(this)">
  <div class="card-body">
    <div class="alert alert-info">
      <ul>
        <li><?php print $lang['certificates']['es-ministerio-lev-1-app']['content']['app-fee'] ?></li>
        <li><?php print $lang['certificates']['es-ministerio-lev-1-app']['content']['all-fields-required'] ?></li>
      </ul>
    </div>
    <?php echo $hidden_fields_string ?>
    <div class="form-group row">
      <label for="display_date" class="col-sm-3 col-form-label">
        <?php echo $lang['certificates']['es-ministerio-lev-1-app']['content']['date'] ?>
      </label>
      <div class="col-sm-9">
    ...
    <div class="form-group row">
      <label for="display_name" class="col-sm-3 col-form-label">
        <?php echo $lang['certificates']['es-ministerio-lev-1-app']['content']['name'] ?>
      </label>
      <div class="col-sm-9">
    ...
    <div class="form-group row">
      <label for="display_username" class="col-sm-3 col-form-label">
        <?php echo $lang['certificates']['es-ministerio-lev-1-app']['content']['username'] ?>
      </label>
      <div class="col-sm-9">
    ...
    <div class="form-group row">
      <label for="display_email" class="col-sm-3 col-form-label">
        <?php echo $lang['certificates']['es-ministerio-lev-1-app']['content']['email-address'] ?>
      </label>
      <div class="col-sm-9">
    ...
    <div class="form-group row">
      <label for="display_diocese" class="col-sm-3 col-form-label">
        <?php echo $lang['certificates']['es-ministerio-lev-1-app']['content']['diocese'] ?>
      </label>
      <div class="col-sm-9">
    ...
    <div class="form-group row">
      <label for="parish_school_name" class="col-sm-3 col-form-label">
        <?php echo $lang['certificates']['es-ministerio-lev-1-app']['content']['parish-school-name'] ?>
      </label>
      <div class="col-sm-9">
  ...
  <div class="card-body">
    <div class="alert alert-info">
      <?php echo $lang['certificates']['es-ministerio-lev-1-app']['content']['current-ministry'] ?>
    </div>
    <div class="form-group row">
      <label for="parish_program" class="col-sm-3 col-form-label">
        <?php echo $lang['certificates']['es-ministerio-lev-1-app']['content']['parish-program'] ?>
      </label>
      <div class="col-sm-9">
    ...
    <div class="form-group row">
      <label for="parish_program_grade_level" class="col-sm-3 col-form-label">
        <i class="fa fa-arrow-right"></i> <?php echo $lang['certificates']['es-ministerio-lev-1-app']['content']['grade-level'] ?>
      </label>
      <div class="col-sm-9">
    ...
    <div class="form-group row">
      <label for="catholic_school" class="col-sm-3 col-form-label">
        <?php echo $lang['certificates']['es-ministerio-lev-1-app']['content']['catholic-school'] ?>
      </label>
      <div class="col-sm-9">
  ...
  <div class="card-body">
    <div class="form-group">
      <label for="reason_to_participate">
        <?php echo $lang['certificates']['es-ministerio-lev-1-app']['content']['reason-to-participate'] ?>
      </label>
    ...
    <div class="form-group">
      <label for="workshops_or_courses">
        <?php echo $lang['certificates']['es-ministerio-lev-1-app']['content']['workshops-courses'] ?>
      </label>
    ...
    <div class="form-group">
      <label for="other_ministry">
        <?php echo $lang['certificates']['es-ministerio-lev-1-app']['content']['other-ministry'] ?>
      </label>
    ...
    <input type="submit" class="submit-button btn btn-vlc" value="<?php print $lang['certificates']['es-ministerio-lev-1-app']['content']['submit'] ?>">
  </div>
