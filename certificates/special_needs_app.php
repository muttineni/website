...
$page_info['page'] = 'special_needs-app';
$page_info['login_required'] = 1;
list($user_info, $lang, $status_message, $header) = vlc_header($site_info, $page_info);
/* get special certificate application status from session variable */
if (!isset($_SESSION['special_needs_cert_app_status']) or $_SESSION['special_needs_cert_app_status'] != 1) vlc_redirect('certificates/special_needs.php');
...
{
  if ($user_details['is_partner']) $user_details['diocese'] .= ' ('.$lang['certificates']['special_needs_app']['content']['partner'].')';
  else $user_details['diocese'] .= ' ('.$lang['certificates']['special_needs_app']['content']['non-partner'].')';
}
else
{
  $user_details['diocese'] = $lang['certificates']['special_needs_app']['content']['no-diocese'];
}
$hidden_fields_string = '<input type="hidden" name="cert_prog_id" value="15">';
$hidden_fields_string .= '<input type="hidden" name="app_lang" value="1">';
$hidden_fields_string .= '<input type="hidden" name="certificate_program" value="'.$lang['certificates']['special_needs_app']['content']['cert-prog'].'">';
...
<!-- begin page content -->
<div class="container">
<h1><?php print $lang['certificates']['special_needs_app']['page-title'] ?></h1>
<div class="card"><form action="cert_app_action.php" method="post" onsubmit="return validate_form(this)">
  <div class="card-body">
    <div class="alert alert-info">
      <ul>
        <li><?php print $lang['certificates']['special_needs_app']['content']['app-fee'] ?></li>
        <li><?php print $lang['certificates']['special_needs_app']['content']['all-fields-required'] ?></li>
      </ul>
    </div>
    <?php echo $hidden_fields_string ?>
    <div class="form-group row">
      <label for="display_date" class="col-sm-3 col-form-label">
        <?php echo $lang['certificates']['special_needs_app']['content']['date'] ?>
      </label>
      <div class="col-sm-9">
    ...
    <div class="form-group row">
      <label for="display_name" class="col-sm-3 col-form-label">
        <?php echo $lang['certificates']['special_needs_app']['content']['name'] ?>
      </label>
      <div class="col-sm-9">
    ...
    <div class="form-group row">
      <label for="display_username" class="col-sm-3 col-form-label">
        <?php echo $lang['certificates']['special_needs_app']['content']['username'] ?>
      </label>
      <div class="col-sm-9">
    ...
    <div class="form-group row">
      <label for="display_email" class="col-sm-3 col-form-label">
        <?php echo $lang['certificates']['special_needs_app']['content']['email-address'] ?>
      </label>
      <div class="col-sm-9">
    ...
    <div class="form-group row">
      <label for="display_diocese" class="col-sm-3 col-form-label">
        <?php echo $lang['certificates']['special_needs_app']['content']['diocese'] ?>
      </label>
      <div class="col-sm-9">
    ...
    <div class="form-group row">
      <label for="parish_school_name" class="col-sm-3 col-form-label">
        <?php echo $lang['certificates']['special_needs_app']['content']['parish-school-name'] ?>
      </label>
      <div class="col-sm-9">
  ...
  <div class="card-body">
    <div class="alert alert-info">
      <?php echo $lang['certificates']['special_needs_app']['content']['current-program'] ?>
    </div>
    <div class="form-group row">
      <label for="diocese_parish_name" class="col-sm-3 col-form-label">
        <?php echo $lang['certificates']['special_needs_app']['content']['diocese-or-parish'] ?>
      </label>
      <div class="col-sm-9">
        <input type="text" name="diocese_parish_name" id="diocese_parish_name" class="form-control form-field" value="<?php echo $form_fields['diocese_parish_name']?>" />
      </div>
    </div>
    <div class="form-group row">
      <label for="diocese_parish_program_name" class="col-sm-3 col-form-label">
        <i class="fa fa-arrow-right"></i> <?php echo $lang['certificates']['special_needs_app']['content']['program-name'] ?>
      </label>
      <div class="col-sm-9">
        <input type="text" name="diocese_parish_program_name" id="diocese_parish_program_name" class="form-control form-field" value="<?php echo $form_fields['diocese_parish_program_name']?>" />
      </div>
    </div>
    <div class="form-group row">
      <label for="catholic_school" class="col-sm-3 col-form-label">
        <?php echo $lang['certificates']['special_needs_app']['content']['catholic-school'] ?>
      </label>
      <div class="col-sm-9">
        <input type="text" name="catholic_school" id="catholic_school" class="form-control form-field" value="<?php echo $form_fields['catholic_school']?>" />
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-sm-9">
        <input type="text" name="catholic_school_program_name" id="catholic_school_program_name" class="form-control form-field" value="<?php echo $form_fields['catholic_school_program_name']?>" />
      </div>
    </div>
  </div> <!-- end card body -->
  ...
  <div class="card-body">
    <div class="form-group">
      <label for="reason_to_participate">
        <?php echo $lang['certificates']['special_needs_app']['content']['reason-to-participate'] ?>
      </label>
    ...
    <div class="form-group">
      <label for="workshops_or_courses">
        <?php echo $lang['certificates']['special_needs_app']['content']['workshops-courses'] ?>
      </label>
    ...
    <div class="form-group">
      <label for="other_ministry">
        <?php echo $lang['certificates']['special_needs_app']['content']['other-ministry'] ?>
      </label>
    ...
    <input type="submit" class="submit-button btn btn-vlc" value="<?php print $lang['certificates']['special_needs_app']['content']['submit'] ?>">
  </div>
