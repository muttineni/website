...
if ($user_info['user_id'] != 559 or $_SERVER['REMOTE_ADDR'] != '131.238.77.66')
{
  $query_status_msg = '<p>You are not authorized to execute queries on this page.</p>';
}
elseif (isset($_GET['sql']) and isset($_GET['format']))
{
