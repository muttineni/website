...
Version 2.1.1,  August 9th, 2007 (gfb)  - Add switch to turn off Year Span Selection (This allows me to only have this year & next year in the drop down)
Version 2.1.2,  August 30th, 2007 (gfb) - Add switch to start week on Sunday
...
var languageCode = curr_lang;
var calendar_display_time = true;
var todayStringFormat = '[todayString] [UCFdayString]. [day]. [monthString] [year]';
var pathToImages = home_url + 'js/calendar/';
...
function writeCalendarContent() {
  ...
  if (!document.all) {
    if (calendarContentDiv.offsetHeight) document.getElementById('topBar').style.top = calendarContentDiv.offsetHeight + document.getElementById('timeBar').offsetHeight + document.getElementById('topBar').offsetHeight - 1 + 'px';
    else {
...
function initCalendar() {
  if (MSIE) {
    ...
    iframeObj2.src = pathToImages + 'blank.html';
    iframeObj.src = pathToImages + 'blank.html';
...
function displayCalendarSelectBox(yearInput, monthInput, dayInput, hourInput, minuteInput, buttonObj) {
  if (!hourInput) calendarDisplayTime = false;
  else calendarDisplayTime = true;
  currentYear = yearInput.options[yearInput.selectedIndex].value;
  if (isNaN(currentYear)) {
    var d = new Date();
    inputYear = currentYear = d.getFullYear();
    inputMonth = currentMonth = d.getMonth();
    inputDay = d.getDate();
  } else {
    inputYear = currentYear;
    inputMonth = currentMonth = monthInput.options[monthInput.selectedIndex].value / 1 - 1;
