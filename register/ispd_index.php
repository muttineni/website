...
END_QUERY;
      ...
      $page_content .= '<thead><tr><th scope="col">'.$lang['register']['index']['misc']['course-code'].'</th><th scope="col">'.$lang['register']['index']['misc']['course-name'].'</th><th scope="col">'.$lang['register']['index']['misc']['ceu'].'/'.$lang['register']['index']['misc']['credit'].'</th><th scope="col">'.$lang['register']['index']['misc']['facilitator'].'</th><th scope="col">'.$lang['register']['index']['misc']['register-label'].'</th></tr></thead>';
      $i = 0;
      foreach ($course_array as $course)
      {
        ...
        $page_content .= '<tr>';
        /* if the student is already registered for the course, show a disabled register button */
        if (in_array($course_id, $student_course_array))
        {
          $register_form = '<form method="post" action="ispd_register_action.php" onsubmit="return false;">';
        ...
        elseif ($num_students >= 300)
        {
          $register_form = '<form method="post" action="ispd_register_action.php">';
