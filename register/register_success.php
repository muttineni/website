...
if ($form_fields['registration_type_id'] == 1) {
  $course_details_table .= '<tr><th scope="row">'.$lang['register']['common']['misc']['discount-type-label'].'</th><td>'.$course_details ['discount_type_description'].'</td></tr>';
  $course_details_table .= '<tr><th scope="row">'.$lang['register']['common']['misc']['discount-label'].'</th><td>'.$course_details  ['discount_description'].'</td></tr>';
...
$course_details_table .= '<tr><th scope="row">'.$lang['register']['common']['misc']['scoring-label'].'</th><td>'.$scoring.'</td></tr>'; 
...
if ($form_fields['action_id'] == 1)
{
  ...
  $output .= '</ul>';
  if ($course_details['num_required'] > 0) $output .= '<h3>'.$lang['register']['success']['heading']['where-to-buy'].'</h3>'.$lang['register']['success']['content']['where-to-buy'];
  $output .= '<h3>'.$lang['register']['success']['heading']['course-access'].'</h3>'.$lang['register']['success']['content']['course-access'];
  $output .= '<h3>'.$lang['register']['success']['heading']['username-password'].'</h3>'.$lang['register']['success']['content']['username-password'];
  $output .= '<h3>'.$lang['register']['success']['heading']['additional-materials'].'</h3>'.$lang['register']['success']['content']['additional-materials'];
  $output .= '<h3>'.$lang['register']['success']['heading']['technical-support'].'</h3>'.$lang['register']['success']['content']['technical-support'];
}
