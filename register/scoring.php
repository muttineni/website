...
<!-- begin page content -->
<h1><?php print $lang['register']['scoring']['page-title'] ?></h1>
<?php print $lang['register']['scoring']['content']['scoring'] ?>
<p style="text-align: center;"><?php print $lang['register']['scoring']['content']['print-link'] ?> - <?php print $lang['register']['scoring']['content']['close-window-link'] ?></p>
<!-- end page content -->
</body>
</html>
